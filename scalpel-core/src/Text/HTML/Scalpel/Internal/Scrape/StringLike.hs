...
-- | The 'scrapeStringLike' function parses a 'TagSoup.StringLike' value into a
-- list of tags and executes a 'Scraper' on it.
scrapeStringLike :: (TagSoup.StringLike str)
                 => str -> Scraper str a -> Maybe a
scrapeStringLike = fmap runIdentity . scrapeStringLikeT

-- | The 'scrapeStringLikeT' function parses a 'TagSoup.StringLike' value into a
-- list of tags and executes a 'ScraperT' on it. Since 'ScraperT' is a monad
